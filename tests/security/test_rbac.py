...
@pytest.fixture
def rbac_manager(mock_redis: AsyncMock) -> RBACManager:
...
class TestRBACManager:
    ...
    async def test_create_role(
        self, rbac_manager: RBACManager, mock_redis: AsyncMock,
    ) -> None:
...
@pytest.mark.security
@pytest.mark.asyncio
async def test_initialize_rbac(mock_redis: AsyncMock) -> None:
