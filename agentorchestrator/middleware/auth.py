...
class AuthConfig(BaseModel):
    ...
    enabled: bool = True
    public_paths: List[str] = ["/", "/api/v1/health", "/docs", "/redoc", "/openapi.json", "/openapi.json/"]
...
class AuthMiddleware:
    ...
    def __init__(self, app: Callable, redis_client: Redis, config: Optional[AuthConfig] = None):
